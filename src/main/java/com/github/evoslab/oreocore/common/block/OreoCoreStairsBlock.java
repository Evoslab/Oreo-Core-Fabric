package com.github.evoslab.oreocore.common.block;
...
public class OreoCoreStairsBlock extends Block implements Waterloggable {
    ...
    protected OreoCoreStairsBlock(BlockState baseBlockState, AbstractBlock.Settings settings) {
        super(settings);
